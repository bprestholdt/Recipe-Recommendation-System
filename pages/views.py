...
import openai
import re
def generate_recipe_chatGPT(ingredients, author):
    try: 
...
def home(request):
  ...
  },
  {
    ...
    example_generated_recipes = []
      # Loop through example recipes and generate new recipes
    for recipe in example_recipes:
        ingredients = recipe['ingredients']
        author = recipe['author']
        example_generated_recipe = generate_recipe_chatGPT(ingredients, author)
        if example_generated_recipe:
            example_generated_recipes.append(example_generated_recipe)
        else:
            # Handle error or fallback to default recipe example
            example_generated_recipes.append(recipe)
    ...
    context = {
        'example_generated_recipes': example_generated_recipes,
        'form': RecipeForm(),
    }
